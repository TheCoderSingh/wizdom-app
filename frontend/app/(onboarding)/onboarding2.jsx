...
const onboarding2 = () => {
  return (
    <View className="w-[85%] mx-auto">
     ...
     <Text className="text-primary font-primaryBold text-3xl mt-10 tracking-wider">What's your name?</Text>
     ...
     <Text className="text-primary font-primaryBold text-3xl mt-10 tracking-wider">What's your gender?</Text>
