  ...
  return (
    <View className="w-[85%] mx-auto flex justify-between h-full">
     <View>
        ...
        <Text className="text-heading font-primaryBold text-3xl mt-10 tracking-wider">Where can we learn about you?</Text>
        ...
        <Text className="text-heading font-primaryBold text-3xl mt-10 tracking-wider">What are you interested in?</Text>
